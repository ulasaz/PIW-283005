  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-8 sm:p-10 rounded-[32px] shadow-sm border border-gray-100 flex flex-col gap-6">
      ...
      <div>
        ...
        <textarea required rows={5} defaultValue={Array.isArray(game.description) ? game.description.join('\n') : (game.description || "")} className="w-full rounded-xl border border-gray-300 py-3.5 px-4 outline-none focus:border-black focus:ring-2 focus:ring-black bg-gray-50 focus:bg-white transition-all text-sm resize-none"></textarea>
      </div>
